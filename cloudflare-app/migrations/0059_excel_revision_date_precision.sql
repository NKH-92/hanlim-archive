-- Excel 제·개정일은 전체 날짜(YYYY-MM-DD)와 연도만(YYYY)을 모두 보존한다.
...
CREATE TABLE documents_new (
  ...
  revision_date TEXT CHECK (
    revision_date IS NULL
    OR revision_date GLOB '[0-9][0-9][0-9][0-9]'
    OR revision_date GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]'
  ),
